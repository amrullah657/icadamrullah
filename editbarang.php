        ...
        <div class="container-fluid">
            ...
            <form class="username" method="POST">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" placeholder="Kode Barang" name="kode_brg" value="<?php echo $barang['kode_brg']; ?>">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" placeholder="Nama Barang" name="nama_brg" value="<?php echo $barang['nama_brg']; ?>">
                </div>
                <div class="form-group">
